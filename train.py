...
from model.SEResNet import SEResNet, SEBasicBlock
...
def get_args_parser():
    parser = argparse.ArgumentParser('SE ResNet for CIFAR-10', add_help=False)
...
def main():
    ...
    model = SEResNet(SEBasicBlock, 9).to(device)
